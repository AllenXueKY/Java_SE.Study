...
public class GameRoom {
	...
	public GameRoom(String roomName,String roomPass){
		if (!("AllenXue的游戏盒子".equals(roomName) && "123".equals(roomPass))) {
	...
	private void gaming() {
		while(true){
			...
			//判断输赢
			int result = juge(fist1, fist2);//调用方法判断结果
	 ...
	 * @return
	 */
	public int juge(int fist1,int fist2){
		if (fist1 == fist2) return 0;//平局
		if (fist1 ==1 && fist2 == 2&& fist2 == 1 || fist1 == 3 && fist2 == 2) {
			//玩家1的分数+1，玩家2的分数+1
